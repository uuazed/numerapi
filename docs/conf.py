...
# sphinx-quickstart on Thu Jan 11 23:05:59 2018.
#
...
import numerapi
version = release = numerapi.__version__
...
latex_documents = [
    (master_doc, 'numerapi.tex', 'numerapi Documentation',
     'uuazed', 'manual'),
]
...
man_pages = [
    (master_doc, 'numerapi', 'numerapi Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'numerapi', 'numerapi Documentation',
     author, 'numerapi', 'One line description of project.',
     'Miscellaneous'),
]
